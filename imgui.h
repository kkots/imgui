...
#ifndef ImTextureID
typedef UITexture ImTextureID;          // Default: store a pointer or an integer fitting in a pointer (most renderer backends are ok with that)
#endif
...
namespace ImGui
{
    extern bool imGuiTextOutlined;
    extern bool IsNextWindowPinned;
    extern int  NextWindowPinnedOrder;
    ...
    IMGUI_API bool          WindowIsNotNull();
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_HasPinButton           = 1 << 19,
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddPolylineClosedLoop(const ImVec2* points, int num_points, ImU32 col, float thickness);
    IMGUI_API void  AddPolylineCached(const ImVec2* pointsOuter, const ImVec2* pointsInner, int num_points, ImU32 col);
...
struct ImFontGlyph
{
    ...
    float           X0Outlined, Y0Outlined, X1Outlined, Y1Outlined;     // Glyph corners
    float           U0Outlined, V0Outlined, U1Outlined, V1Outlined;     // Texture coordinates
};
